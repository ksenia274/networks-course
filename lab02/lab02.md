...
#### Решение
Пакеты не будут стоять в очереди после прохождения первого пакета, так как у него самая низкая скорость передачи данных. Посчитаем, сколько будет занимать передача всего файла.
