...
2. Каков IP-адрес у сервера gaia.cs.umass.edu? Каковы номера портов для отправки и приема
   ...
   - ip: 128.119.245.12
   <img src="images/2.png" width=600 />
   - 52037 порт и 80 порт - порт сервера.
...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - Порядковый номер октета, который отправитель данного сегмента желает получить
   - Syn и Acknowledgment биты установлены в 1
...
5. Какой порядковый номер у TCP-сегмента, содержащего команду POST протокола HTTP?
   ...
   - Sequence number: 1
     (Справа в колонке видно, что команда - именно post)
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - 1, 635, 1983, 3331, 4679, 6027
   <img src="images/6.png" width=600 />
   <img src="images/7.png" width=600 />
   <img src="images/8.png" width=600 />
   <img src="images/9.png" width=600 />
   <img src="images/10.png" width=600 />
   - 21.632997, 21.633048, 21.633049, 21.633049, 21.633049, 21.633050
   - 21.790466, остальные - формально 21.790467, но фактически в wireshark этого не видно
   - RTT - разница между временем получения и временем отправления
   <img src="images/11.png" width=600 />
   - 0.165790, 0.157419, 0.157418, 0.157418, 0.157418, 0.157417
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - $RTT$ = 0.158813
   - Win = 132096 байт
   - Capacity = $\dfrac{Win}{RTT}$ = 831770,7 байт/с = 812 Мб/с
...
#### Демонстрация работы
<img src="images/server1.png" width=600 />

<img src="images/client1.png" width=600 />
...
<img src="images/client2.png" width=600 />
...
#### Демонстрация работы
Режим работы - один сервер, один клиент
<img src="images/server3.png" width=600 />

<img src="images/client3.png" width=600 />

Для хорошего тестирования работы с несколькими клиентами я использовала файлик more_clients.py.
<img src="images/server4.png" width=600 />

<img src="images/client4.png" width=600 />
